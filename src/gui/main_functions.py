...
class MainFunctions:
    ...
    def setup_widgets(self):
        ...
        self.ui.user_picture.setStyleSheet(
            f"background-image: url(':/myresource/resource/format_lab_small.png'); background-position: center;")
        ...
        self.playlist = PyLeftButton(
            "Import Audio",
            icon_name=":/myresource/resource/music_left.png",
            is_active=True
        )

        self.downloads = PyLeftButton(
            "Converted Files",
            icon_name=":/myresource/resource/folder_left.png",
            is_active=True
        )
